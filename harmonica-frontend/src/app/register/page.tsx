...
import { Radio, Mail, Lock, User, Loader2, ArrowRight } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Registration successful! Welcome to Harmonica.');
    } catch (err: any) {
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-panel rounded-3xl p-8 border border-zinc-800/80 shadow-2xl">
          ...
          <p className="text-zinc-400 text-sm mb-6">
            Join Harmonica and start optimizing your DJ sets.
          </p>
